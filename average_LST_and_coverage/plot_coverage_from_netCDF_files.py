...
for REGION in REGIONS:
    ...
    if REGION == 'EUROPE':
        ...
        ax1.set_extent((-18.0, 58, np.amin(LATS)-0.5, 55), crs = ccrs.PlateCarree())
        ax2.set_extent((-18.0, 58, np.amin(LATS)-0.5, 55), crs = ccrs.PlateCarree())
        ax3.set_extent((-18.0, 58, np.amin(LATS)-0.5, 55), crs = ccrs.PlateCarree())
        ax4.set_extent((-18.0, 58, np.amin(LATS)-0.5, 55), crs = ccrs.PlateCarree())
