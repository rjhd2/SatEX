...
for indexname in UNITS_DICT.keys():
    ...
    for REGION in REGIONS:
        ...
        fig=plt.figure(figsize = (10, 8))
        plt.plot(times_datetime, YDATA)
        plt.plot(times_datetime, trendline, label='trend: '+str(round(slope*time_factor,2))+ ' ' + UNITS_DICT[indexname]+' per decade'+ ' (1991-2015)')
        plt.plot(times_datetime1, trendline1, label='trend: '+str(round(slope1*time_factor,2))+ ' ' + UNITS_DICT[indexname]+' per decade'+ ' (1991-2004)')
        plt.plot(times_datetime2, trendline2, label='trend: '+str(round(slope2*time_factor,2))+ ' ' + UNITS_DICT[indexname]+' per decade'+ ' (2005-2015)')
        ...
        if REGION == 'GERMANY':
            slopes_ANN_GERMANY[indexname] = [str(round(slope*time_factor,2)), str(round(slope1*time_factor,2)), str(round(slope2*time_factor,2))]
        elif REGION == 'SPAIN':
            slopes_ANN_SPAIN[indexname] = [str(round(slope*time_factor,2)), str(round(slope1*time_factor,2)), str(round(slope2*time_factor,2))]
        elif REGION == 'MOROCCO':
            slopes_ANN_MOROCCO[indexname] = [str(round(slope*time_factor,2)), str(round(slope1*time_factor,2)), str(round(slope2*time_factor,2))]
