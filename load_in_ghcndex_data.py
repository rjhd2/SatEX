...
def plot_figure(data, gridlons, gridlats, title):
    ...
    plt.tight_layout()
    plt.savefig(OUTPATH+indexname+'_map_of_trend.png')
    return
...
#'HW': 'days', 'TMGE10': 'days', 'TMGE5': 'days', 'TMLT10': 'days', 'TMLT10': 'days', 'TMm': u'\u00B0C','TMLT5': 'days',
...
for indexname in UNITS_DICT.keys():
    ...
    plot_figure(TRENDS_ANN, GRIDLONS, GRIDLATS, 'Trend of '+ indexname)
