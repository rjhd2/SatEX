...
DATALOC = "/scratch/vportge/CM_SAF_LST_MIN_MAX_WARM_WINDOW_10_3/"

MIN_OR_MAX = 'max'

#OUTDIR = '/scratch/vportge/concatenated_yearly_files/'+MIN_OR_MAX+'_LST_in_cold_window/'
OUTDIR = '/scratch/vportge/concatenated_yearly_files/warm_window_10_3/'+MIN_OR_MAX+'_LST_in_cold_window/'
...
print("saving")
iris.save(final_cubes, OUTDIR+str(YEARS[0])+'_'+str(YEARS[-1])+'_'+MIN_OR_MAX+'_lst_cold_win.nc', zlib = True)
